...
import { IMG_MANUFACTURING_HERO_URL as hero } from "@/lib/migratedImageUrls";
import { IMG_MANUFACTURING_TRADITIONAL_FAIL_URL as tradFail } from "@/lib/migratedImageUrls";
import { IMG_MANUFACTURING_PROBLEM_P1_URL as p1 } from "@/lib/migratedImageUrls";
import { IMG_MANUFACTURING_PROBLEM_P2_URL as p2 } from "@/lib/migratedImageUrls";
import { IMG_MANUFACTURING_PROBLEM_P3_URL as p3 } from "@/lib/migratedImageUrls";
import { IMG_MANUFACTURING_UC_1_URL as u1 } from "@/lib/migratedImageUrls";
import { IMG_MANUFACTURING_UC_2_URL as u2 } from "@/lib/migratedImageUrls";
import { IMG_MANUFACTURING_UC_3_URL as u3 } from "@/lib/migratedImageUrls";
import { IMG_MANUFACTURING_UC_4_URL as u4 } from "@/lib/migratedImageUrls";
...
export const MANUFACTURING_DEFAULTS = {
  ...
  "The Problem": {
    ...
    items: [
      { n: "01", label: "RISK", title: "Disconnected Planning", body: "Production plans change without inventory visibility. Raw materials arrive too late or overstocked, and procurement never sees what production actually needs.", image: p1 },
      { n: "02", label: "RISK", title: "Manual Work Orders", body: "Work orders are managed manually across departments. BOM changes are not reflected in real time, so engineering updates never reach the shop floor.", image: p2 },
      { n: "03", label: "RISK", title: "Invisible Costing", body: "Costing is calculated after production, not during it. No live view of shop floor performance means decisions are made on delayed, incomplete reports.", image: p3 },
    ],
  },
  "Traditional Fail": {
  ...
  "Use Cases": {
    ...
    items: [
      { n: "01", title: "High-volume production with fluctuating demand", body: "Synchronized demand planning, material readiness, and capacity scheduling to absorb volume variability without overstock or delays.", image: u1 },
      { n: "02", title: "Multi-warehouse manufacturing operations", body: "Unified material visibility, inter-warehouse transfers, and live inventory positioning across multiple production and storage sites.", image: u2 },
      { n: "03", title: "Batch production with strict traceability", body: "Lot-controlled production with end-to-end traceability across raw materials, in-process operations, and finished goods.", image: u3 },
      { n: "04", title: "Custom manufacturing with frequent BOM changes", body: "Version-controlled BOMs with engineering change management built into the production and costing workflow.", image: u4 },
    ],
  },
  "Business Impact": {
