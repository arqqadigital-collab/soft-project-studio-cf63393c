...
export const STAFF_AUG_DEFAULTS = {
  ...
  Services: {
    ...
    items: [
      ...
      { n: "08", icon: "AppWindow", group: "Managed Services", title: "Application Managed Services", tagline: "Keep your business-critical applications running at their best.", body: "Mission-critical applications require ongoing care — monitoring, patching, enhancements, and user support. SBS provides end-to-end application managed services that ensure your platforms perform reliably and continue to evolve alongside your business needs.", bullets: ["Application monitoring and availability management", "Bug fixes, patches, and routine updates", "Minor enhancements and configuration changes", "Vendor liaison and escalation management", "Monthly application health reports"], image: s8 },
    ],
  },
  "Why SBS": {
