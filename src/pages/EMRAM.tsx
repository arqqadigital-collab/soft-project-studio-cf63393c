...
const features = [
  ...
  { icon: Map, title: "Stage-by-Stage Roadmap", body: "A detailed, time-bound roadmap from your current position to Stage 7. Each stage specifies technology, workflow redesign, integration, adoption milestones and validation criteria — sequenced to minimize operational disruption." },
  { icon: Workflow, title: "Clinical Workflow Digitization", body: "Our clinical transformation team works alongside your leads to redesign workflows, build adoption and achieve the sustained usage rates EMRAM validation requires. Technology without adoption does not pass EMRAM. We manage both." },
  { icon: Pill, title: "Closed-Loop Medication Safety", body: "End-to-end closed-loop medication: ePrescribing, pharmacy verification, dispensing cabinet integration and barcode-verified bedside administration — delivered with the change management needed for consistent staff compliance." },
  { icon: Brain, title: "Clinical Decision Support Maturity", body: "Condition-specific order sets, evidence-based pathways, sepsis screening, deterioration alerts and preventive reminders — built, configured, validated and measured against the clinical outcomes EMRAM assessors look for." },
  { icon: Database, title: "Data Integration & Interoperability", body: "Target integration architecture with HL7 FHIR interfaces, clinical data repositories and master patient index. Every system talks to every other system — patient data follows the patient without gaps, delays or manual reconciliation." },
  { icon: Sparkles, title: "AI Readiness Assessment", body: "Evaluation of data completeness, data quality, governance maturity, clinical AI literacy and infrastructure capacity against the requirements for safe, effective clinical AI deployment — with a targeted program to close every gap." },
  { icon: BadgeCheck, title: "Validation Preparation & Support", body: "Documentation preparation, leadership coaching, pre-validation mock assessments and on-site support through formal HIMSS validation — followed by operational sustainability practices to maintain your stage." },
];
        ...
        <div className="mx-auto max-w-6xl">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-5 text-base leading-relaxed text-foreground/70 md:text-lg">
              Eight integrated capabilities that take your organization from baseline assessment through Stage 7
              validation — and into a future of meaningful clinical AI.
            </p>
          </div>
      ...
      <section className="bg-background px-6 py-24 md:px-12 md:py-32">
        <div className="mx-auto max-w-6xl">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-5 text-base leading-relaxed text-foreground/70 md:text-lg">
              Seven sequenced stages that take your organization from current state to validated digital excellence —
              and into sustained AI-enabled operation.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mx-auto mt-6 max-w-3xl text-base leading-relaxed text-foreground/70 md:text-lg">
              EMRAM Stage 7 requires a fully integrated digital hospital. Our integration framework connects every
              clinical system — EMR, laboratory, radiology, pharmacy, operating theatre, ICU and more — through a
              standards-based interoperability architecture that meets HIMSS EMRAM validation requirements.
            </p>
          </div>
      ...
      >
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <p className="mt-8 text-lg leading-relaxed text-white/80">
            A Stage 7 hospital has the digital foundation to deploy clinical AI that saves lives, predict deterioration
            before it happens, manage populations proactively and deliver care measurably safer, faster and more
            effective than fragmented systems can support. The path starts with knowing where you are today.
          </p>
          ...
          <p className="mt-8 text-sm italic text-white/60">
            Advisory and implementation support available in Arabic and English. GCC and international experience.
            Assessment findings delivered within 4 weeks.
          </p>
        </div>
      </section>
