...
import { useHospitalOperationsContent } from "@/lib/hospitalOperationsContent";

const ICONS: Record<string, any> = {
  MapPin, BedDouble, Radio, Wrench, Thermometer, Users, Activity, Boxes, ClipboardList, Workflow,
};
...
export default function HospitalOperations() {
  const c = useHospitalOperationsContent();
      ...
      {c._visible["Patient Journey"] && (
        ...
        >
          <div className="relative mx-auto max-w-7xl">
            ...
            <ExpandingJourney steps={((c["Patient Journey"] as any).items ?? []) as any[]} />
          </div>
        </section>
      )}
        ...
        <section className="px-6 py-24 md:px-12">
          <div className="mx-auto max-w-6xl text-center">
            ...
            <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
              {(c.Integrations.tags ?? []).map((label: string) => (
                <span
                  key={label}
