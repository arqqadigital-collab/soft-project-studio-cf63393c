...
const features = [
  {
    ...
    body: "Receive imaging orders directly from your HIS or EMR. Schedule patients against modality availability, technologist assignments, and room capacity. Eliminate double bookings with real-time calendar logic and automated patient notifications.",
  },
  {
    icon: ScanLine,
    title: "DICOM Image Linking & Viewer",
    body: "Automatically link acquired images to their corresponding orders and patient records. Launch your PACS viewer directly from within the RIS with a single click — no hunting through separate systems.",
  },
  {
    icon: FileText,
    title: "Structured Reporting & Voice",
    body: "Give radiologists a faster way to report. Choose procedure-specific structured templates or dictate findings with integrated voice recognition. Reports are auto-populated and ready for sign-off in seconds.",
  },
  {
    icon: ListChecks,
    title: "Intelligent Worklist Prioritization",
    body: "Studies are automatically triaged by urgency, modality, patient age, and clinical indication. Critical and STAT studies surface to the top so nothing urgent is missed or delayed.",
  },
  {
    icon: UserCheck,
    title: "Referring Physician Portal",
    body: "Give referring doctors instant, secure access to final reports and linked images the moment they're signed. A clean, role-based portal accessible from any device — no phone calls, no faxes.",
  },
  {
    icon: BellRing,
    title: "Critical Finding Alerts",
    body: "When a radiologist identifies a critical finding, the system triggers an immediate notification to the ordering physician with a mandatory acknowledgment workflow — a defensible communication record.",
  },
];
...
const journey = [
  {
    ...
    image: risJourney1,
    body: "Imaging requests arrive from the EMR, HIS, or are entered directly. Patient demographics, clinical indication, and priority level are captured automatically.",
  },
  {
    icon: CalendarCheck,
    title: "Patient Scheduled",
    image: risJourney2,
    body: "The system matches the order to the right modality, time slot, and technologist. The patient receives a confirmation — no manual coordination required.",
  },
  {
    icon: ImagePlus,
    title: "Images Acquired & Linked",
    image: risJourney3,
    body: "After the scan, DICOM images are automatically associated with the order and patient record. The study appears instantly on the radiologist's worklist.",
  },
  {
    icon: Mic,
    title: "Report Dictated & Signed",
    image: risJourney4,
    body: "The radiologist opens the study, reviews images in the integrated viewer, dictates or types findings using structured templates, and signs the report digitally.",
  },
  {
    icon: Send,
    title: "Report Delivered",
    image: risJourney5,
    body: "The final report is immediately available to the referring physician via portal, HL7 message, or print. The complete study is archived with a full audit trail.",
  },
];
...
const problemCards = [
  {
    title: "Unorganized Worklists",
    image: risProblem1,
    body: "Radiologists buried in unprioritized worklists with no triage logic — critical studies waiting behind routine ones.",
  },
  {
    title: "No Referrer Portal",
    image: risProblem2,
    body: "Referring physicians calling for results because the portal doesn't exist or doesn't work — wasting everyone's time.",
  },
  {
    title: "Unreported Criticals",
    image: risProblem3,
    body: "Critical findings sitting unreported because there's no escalation workflow or mandatory acknowledgment.",
  },
  {
    title: "Manual Image Matching",
    image: risProblem4,
    body: "Hours lost each week manually matching images to orders and reports — and errors when they don't line up.",
  },
  {
    title: "Paper Scheduling",
    image: risProblem5,
    body: "Paper-based scheduling causing double bookings, missed slots, and avoidable machine downtime.",
  },
];
...
const faqs = [
  {
    q: "Does this replace our PACS?",
    a: "No. Secreta RIS works alongside your existing PACS. It manages the workflow — orders, scheduling, worklists, and reporting — while your PACS handles image storage and viewing. The two systems talk seamlessly.",
  },
  {
    q: "How does the voice dictation work?",
    a: "Voice recognition is embedded directly in the reporting screen. Radiologists speak their findings, which are transcribed in real time and mapped to the structured report template. No third-party software required.",
  },
  {
    q: "Can we customize the report templates?",
    a: "Yes. Templates are fully customizable per modality, procedure type, and department. Your team can build and manage templates without any coding.",
  },
  {
    q: "What happens if a critical finding is not acknowledged?",
    a: "The system escalates automatically. If the initial notification isn't acknowledged within your defined timeframe, a second alert is sent to a backup contact, and the event is logged in the audit trail.",
  },
  {
    q: "How long does onboarding take?",
    a: "Most radiology departments are live within 2 to 6 weeks depending on the number of modalities, PACS connections, and custom workflow requirements.",
  },
  {
    q: "Is patient data secure?",
    a: "All data is encrypted in transit and at rest. Role-based access controls ensure users only see what they're authorized to view. HIPAA compliant with local data residency options.",
  },
];
      ...
      <section className="relative z-20 -mt-12 rounded-t-[2.5rem] bg-background px-6 py-24 shadow-[0_-20px_60px_-20px_rgba(0,0,0,0.4)] md:px-12 md:py-32">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <p className="mx-auto mt-8 max-w-3xl text-base leading-relaxed text-muted-foreground md:text-lg">
            A radiology workflow platform that connects your imaging department from order to
            archive. Designed to reduce turnaround times, eliminate paperwork, and give radiologists
            the tools they need to deliver confident, timely reads — every shift, every modality,
            every patient.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-5 text-base leading-relaxed text-foreground/70 md:text-lg">
              From the moment an imaging order is placed to the second the final report lands in the
              physician's hands — Secreta RIS keeps everything connected, documented, and moving.
            </p>
          </div>
      ...
      <section className="px-6 py-24 md:px-12">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-6 text-base leading-relaxed text-foreground/70 md:text-lg">
            Secreta RIS connects with your PACS, HIS, and EMR without disrupting existing workflows.
            Pre-built integrations with Epic, Cerner, Agfa, Philips IntelliSpace, and all major
            HL7-compatible platforms. Full DICOM Worklist (DICOM MWL) support. Open REST API for
            custom connections.
          </p>
      ...
      >
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <p className="mt-8 text-lg leading-relaxed text-white/80">
            Stop losing time to manual worklists, disconnected systems, and delayed reports. Give
            your radiologists and referring physicians the platform that keeps every study moving.
          </p>
          ...
          <p className="mt-8 text-sm italic text-white/60">
            No setup fees. No contracts. Full support from day one.
          </p>
        </div>
      </section>
