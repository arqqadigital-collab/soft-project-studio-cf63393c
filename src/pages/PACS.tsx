...
const features = [
  {
    icon: Layers,
    title: "Universal DICOM Image Acquisition & Storage",
    body: "Receive, store, and manage DICOM images from every modality — CT, MRI, X-ray, fluoroscopy, mammography, tomosynthesis, ultrasound, nuclear medicine, PET-CT, dental, and interventional. Non-DICOM clinical imaging from endoscopy, dermatology, ophthalmology, and pathology is supported through conversion or native storage with full metadata preservation.",
  },
  {
    icon: HardDrive,
    title: "Zero-Loss Archival Architecture",
    body: "Redundant, geographically distributed storage with no single point of failure. Automatic tiering moves active studies to high-speed primary storage and migrates long-term archives to cost-efficient deep storage — without manual intervention or performance compromise on current studies.",
  },
  {
    icon: Monitor,
    title: "High-Performance Diagnostic Viewer",
    body: "A zero-footprint, browser-based diagnostic workstation delivers radiologist-grade display on any authorized device. Advanced visualization — MPR, MIP, volume rendering, 3D reconstruction, and fusion imaging — is built in. Large volumetric studies load in under three seconds on standard clinical hardware.",
  },
  {
    icon: Users,
    title: "Universal Viewing for Clinical Teams",
    body: "Role-appropriate viewing access for surgeons in theatre, oncologists in MDT, physicians at the bedside, and emergency teams in resuscitation. Image quality and tool availability are matched to clinical role — anywhere, on any authorized device.",
  },
  {
    icon: GitBranch,
    title: "Multi-Site Image Management & Sharing",
    body: "A unified imaging infrastructure across hospital groups and regional networks. Studies acquired at any site are accessible to authorized users at every other site in real time — with the patient's complete imaging history visible in one record.",
  },
  {
    icon: Wifi,
    title: "Teleradiology & Remote Reading",
    body: "High-performance image delivery optimized for remote reading over standard internet connections. Diagnostic-quality viewing on calibrated home workstations, integrated voice recognition, and signed reports delivered to the clinical team in real time.",
  },
  {
    icon: History,
    title: "Prior Study Retrieval & Comparison",
    body: "Every new study automatically retrieves relevant prior imaging — by modality, anatomy, and indication — from your archive, federated PACS, and patient-carried media. Interval change is always assessed against the most clinically relevant prior, not whatever is accessible.",
  },
  {
    icon: FileSearch,
    title: "Structured Reporting & RIS Integration",
    body: "Bidirectional integration with your Radiology Information System. Structured reporting templates launch from the viewer pre-populated. Voice dictation is built in. Signed reports transmit to RIS, referring clinicians, and the patient record simultaneously.",
  },
  {
    icon: Disc,
    title: "CD & External Image Import",
    body: "Patient-carried imaging on CD, DVD, or USB is imported through a dedicated workstation that converts external studies to your archival format, associates them with the correct patient, and makes them available for comparison within minutes.",
  },
  {
    icon: Share2,
    title: "Image Exchange & Interoperability",
    body: "Participate in regional and national image sharing networks via IHE XDS-I and Cross-Enterprise Document Sharing. Send and receive studies electronically — no CD burning, no courier dispatch. Integration with Malaffi, Riayati, and NPHIES image exchange is supported.",
  },
];
...
const journey = [
  {
    ...
    body: "The patient is scanned. The modality transmits the study to Secreta PACS via DICOM immediately after acquisition. The study appears in the archive and on the radiologist's worklist within seconds of the last image being generated.",
  },
  {
    icon: History,
    title: "Priors Retrieved",
    image: journeyRetrieve,
    body: "Secreta PACS automatically retrieves the patient's relevant prior studies — from the local archive, from federated PACS systems, and from imported external media — and associates them with the current study for comparison viewing.",
  },
  {
    icon: Eye,
    title: "Displayed & Reported",
    image: journeyReport,
    body: "The radiologist opens the study in the diagnostic viewer. Priors load in the comparison panel automatically. Advanced visualization is available without switching applications. The structured report template opens pre-populated. The radiologist dictates, reviews, and signs.",
  },
  {
    icon: FileCheck,
    title: "Report Delivered",
    image: journeyDeliver,
    body: "The signed report is transmitted to the RIS, referring clinician's EMR view, and patient portal simultaneously. Images are accessible to authorized clinical team members — surgeons, oncologists, emergency physicians — through role-appropriate viewing portals.",
  },
];
...
const problemCards = [
  {
    title: "No Access Outside Radiology",
    image: problemNoAccess,
    body: "A surgeon preparing for a complex procedure cannot access pre-operative imaging from the operating theatre because the PACS is not accessible outside the radiology department.",
  },
  {
    title: "Legacy Archives, Lost History",
    image: problemLegacy,
    body: "Prior studies from a previous admission sit on a legacy system the current PACS cannot retrieve — so the radiologist reads without comparison, missing interval change that would have changed the report.",
  },
  {
    title: "CDs, Couriers, and Trauma Delays",
    image: problemCD,
    body: "A patient arrives in the ED after a road traffic accident. Imaging from the referring hospital cannot be transferred digitally — someone burns a CD, drives it across town, and the trauma team decides from verbal descriptions in the meantime.",
  },
  {
    title: "Storage Failures, Lost Studies",
    image: problemStorage,
    body: "Infrastructure fails during an upgrade and a subset of archived studies becomes inaccessible — triggering a clinical governance incident, a patient safety review, and emergency data recovery that costs more than the original investment.",
  },
  {
    title: "Remote Reading That Doesn't Perform",
    image: problemRemote,
    body: "Radiologists working from home cannot access studies at the same speed or quality as they can in the department — because the PACS architecture was never designed for remote reading.",
  },
];

const faqs = [
  {
    q: "How does Secreta PACS handle migration from our existing PACS?",
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h2 className="mt-6 text-3xl font-bold leading-[1.15] tracking-tight md:text-4xl lg:text-5xl">
            <span style={{ color: "var(--brand-dark)" }}>
              Enterprise Imaging Infrastructure for{" "}
            </span>
            <span
              className="bg-clip-text text-transparent"
              style={{ backgroundImage: "var(--gradient-brand)" }}
          ...
          <p className="mx-auto mt-8 max-w-3xl text-base leading-relaxed text-muted-foreground md:text-lg">
            Medical imaging is one of the most data-intensive, time-critical, and clinically
            consequential workflows in your hospital. When images are delayed, lost, duplicated, or
            inaccessible at the point of clinical decision-making, patients wait longer, diagnoses
            are delayed, and procedures are repeated unnecessarily. Secreta PACS is an
            enterprise-grade picture archiving and communication system that stores, manages,
            distributes, and displays every medical image your facility produces — instantly,
            securely, and from any authorized device anywhere in the world.
          </p>
        </div>
      </section>
        ...
        <div className="sticky top-0 flex min-h-screen flex-col overflow-hidden pb-12 md:pb-16">
          <div className="mx-auto w-full max-w-7xl px-6 pt-14 md:px-12 md:pt-16">
            ...
            <h2 className="mt-5 max-w-5xl text-3xl font-bold leading-[1.1] tracking-tight text-white md:text-4xl lg:text-[2.5rem]">
              Imaging Infrastructure Failures Cost Clinicians Time, Patients Safety, and Hospitals
              Money.{" "}
              <span
                className="bg-clip-text text-transparent"
                style={{ backgroundImage: "var(--gradient-brand)" }}
        ...
        <div className="mx-auto max-w-6xl">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-5 text-base leading-relaxed text-foreground/70 md:text-lg">
              From the scanner room floor to the radiologist's workstation, from the operating
              theatre to the patient's bedside — Secreta PACS delivers every image with reliability,
      ...
      <section className="px-6 py-24 md:px-12">
        <div className="mx-auto max-w-6xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-3xl text-base leading-relaxed text-foreground/70 md:text-lg">
            Secreta PACS integrates with every system that produces, consumes, or references medical
            imaging — from modalities on the scanner room floor to AI engines in the cloud, from the
            RIS to the EMR delivering reports to referring clinicians.
          </p>
            ...
            {[
              ...
              },
              {
                ...
                items: [
                  ...
                  "NPHIES",
                  "Qatar NHIX",
                  "IHE XDS-I Image Exchange Networks",
                ],
              },
              {
                icon: Cpu,
                ...
                items: [
                  ...
                  "Aidoc",
                  "Annalise.ai",
                  "Custom AI vendor integration via DICOM SR & DICOMweb",
                ],
              },
              {
                icon: FileCode2,
                ...
                items: [
                  ...
                  "IEC 62494 Radiation Dose Reporting",
                  "REST API",
                ],
              },
            ].map((group) => {
      ...
      >
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <p className="mt-8 text-lg leading-relaxed text-white/85">
            Medical images drive diagnoses, guide procedures, inform treatment decisions, and create
            the longitudinal visual record of your patients' health over time. They deserve
            infrastructure that stores them without loss, delivers them without delay, displays them
            without compromise, and makes them available to every clinician who needs them —
          ...
          <p className="mt-8 text-sm italic text-white/70">
            Legacy PACS migration support included. On-premise, cloud, and hybrid deployment
            available. Infrastructure assessment delivered within two weeks. Pricing tailored to
            your study volume and site configuration.
          </p>
        </div>
      </section>
