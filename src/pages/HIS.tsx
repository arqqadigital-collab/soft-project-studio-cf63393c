...
import hisHeroVideo from "@/assets/his-hero.mp4";
import hisCtaVideo from "@/assets/his-cta.mp4";
...
const features = [
  {
    icon: UserPlus,
    title: "Patient Registration & Master Patient Index",
    body: "Capture complete demographics, identity verification, insurance and consent at first registration. A Master Patient Index ensures every patient has one unique record across your facility — eliminating duplicates and merging fragmented histories. Biometric identity verification is available at registration and every subsequent point of care.",
  },
  {
    icon: CalendarCheck,
    title: "Outpatient & Appointment Management",
    body: "Manage the full outpatient cycle — booking, scheduling, waiting lists, check-in, consultation documentation and post-consultation workflow. No-show management, recall scheduling and referral tracking are integrated into the same workflow.",
  },
  {
    icon: BedDouble,
    title: "Inpatient Admission, Transfer & Discharge",
    body: "Manage every stage of the inpatient journey with real-time bed visibility across every ward. Discharge summaries are generated from structured clinical data — not written from scratch under time pressure.",
  },
  {
    icon: FileText,
    title: "Electronic Medical Records",
    body: "A complete longitudinal EMR — problem lists, diagnoses, medications, allergies, vital signs, clinical notes, results, imaging and correspondence — accessible to every authorized clinician. One source of truth. No paper backup.",
  },
  {
    icon: ClipboardList,
    title: "Physician Order Management & CPOE",
    body: "Physicians enter all orders electronically with clinical decision support running at the point of every order — drug interactions, allergy alerts, dose validation and duplicate detection. Orders route instantly to the receiving department.",
  },
  {
    icon: HeartPulse,
    title: "Nursing Clinical Documentation",
    body: "Structured assessments, care plans, vitals, fluid balance, wound and pain scoring, fall risk and pressure injury documentation — all electronic, all connected, all visible to the medical team in real time.",
  },
  {
    icon: Pill,
    title: "Pharmacy & Medication Management",
    body: "A closed-loop medication system — prescribing through pharmacy verification, dispensing and barcode-verified bedside administration. Every dose checked, every administration verified, every record current.",
  },
  {
    icon: FlaskConical,
    title: "Laboratory Information System",
    body: "Integrated lab workflows — sample registration, ordering, result entry, validation and delivery — fully connected to the clinical record. Critical values trigger automatic alerts. Result trends visible without leaving the chart.",
  },
  {
    icon: Scan,
    title: "Radiology Information System",
    body: "Integrated radiology order management, scheduling, DICOM image linking and structured reporting. PACS integration delivers images alongside reports without a separate system login.",
  },
  {
    icon: Stethoscope,
    title: "Operating Theatre & Surgical Management",
    body: "Surgical scheduling, pre-op assessment, operative and anesthesia records, implant tracking, recovery and post-op care — all in the HIS. Theatre utilization and outcomes reported automatically.",
  },
  {
    icon: Receipt,
    title: "Revenue Cycle & Billing Management",
    body: "Charges are captured automatically from clinical activity and flow into billing without manual entry. Pre-authorization, claims, adjudication, denials and patient payments — all managed within the HIS.",
  },
  {
    icon: BarChart3,
    title: "Clinical Analytics & Executive Reporting",
    body: "Real-time dashboards for census, occupancy, length of stay, readmissions, infections, surgical outcomes, revenue cycle and productivity — without manual data compilation.",
  },
];
...
const journey = [
  {
    icon: UserPlus,
    title: "Registration",
    image: registrationStep,
    body: "Patient registered with verified identity and complete demographics. A unique master record is created or retrieved. Duplicate detection prevents fragmented histories.",
  },
  {
    icon: CalendarCheck,
    title: "Outpatient Consultation",
    image: outpatientConsultationStep,
    body: "Appointment conducted with full clinical history visible. The physician documents, orders, prescribes and refers — all in one screen, all in one workflow.",
  },
  {
    icon: BedDouble,
    title: "Admission",
    image: admissionStep,
    body: "If admission is required, the patient moves from outpatient directly into inpatient workflow. Bed assignment, assessment, reconciliation and nursing documentation begin immediately.",
  },
  {
    icon: HeartPulse,
    title: "Inpatient Care",
    image: inpatientCareStep,
    body: "Every clinical event — rounds, assessments, investigations, procedures, medications, transfers — is documented in the unified record with continuous decision support.",
  },
  {
    icon: FileText,
    title: "Discharge",
    image: dischargeStep,
    body: "Discharge planning begins at admission. The summary is generated from structured data. Medications are reconciled and follow-up appointments booked through the patient portal.",
  },
  {
    icon: Receipt,
    title: "Billing & Settlement",
    image: billingSettlementStep,
    body: "All clinical activity is captured automatically. Bills are generated from the clinical record, claims submitted electronically and payment reconciled — closing the financial and clinical record together.",
  },
];
...
const stats = [
  {
    value: "1.2 days",
    label: "Average reduction in length of stay within 12 months of full HIS go-live",
  },
  {
    value: "11%",
    label: "Average increase in net revenue per admission through automated charge capture",
  },
  {
    value: "35%",
    label: "Reduction in IT operational cost by replacing point solutions with unified HIS",
  },
  {
    value: "94%",
    label: "First-pass insurance claim acceptance with integrated revenue cycle management",
  },
  {
    value: "Zero",
    label: "Medication reconciliation failures reported across closed-loop medication clients",
  },
  {
    value: "100%",
    label: "Of HIS clients pursuing EMRAM Stage 6 achieved it within their target timeline",
  },
];
...
const faqs = [
  {
    q: "How long does a full HIS implementation take?",
    a: "A community hospital typically completes in 4 to 6 months. A large general hospital with full module deployment and multiple third-party integrations typically takes 9 to 18 months. A phased approach — going live with core modules first and adding clinical modules progressively — is recommended for large facilities.",
  },
  {
    q: "Can Secreta HIS replace our existing systems module by module, or does it require a full replacement?",
    a: "Both approaches are supported. Some clients implement Secreta HIS as a full replacement in a phased go-live. Others implement specific modules — such as the EMR or revenue cycle — alongside existing systems, using integration interfaces, and migrate additional modules over time.",
  },
  {
    q: "How is clinical data migrated from our existing systems?",
    a: "Data migration is managed by Secreta's dedicated team. Clinical data is extracted, transformed to Secreta's data model, validated for completeness and accuracy, and loaded into the new system before go-live. A detailed migration plan is produced before any data movement begins.",
  },
  {
    q: "Does the system support both cloud and on-premise deployment?",
    a: "Yes. Secreta HIS is available as a cloud-hosted solution on regionally compliant infrastructure — including within-country hosting for KSA, UAE and Qatar — and as on-premise. Hybrid deployment is also supported.",
  },
  {
    q: "How does the system handle multiple facilities within the same health group?",
    a: "Multi-site deployment is a core capability of the Health System tier. Each facility runs its own clinical environment with its own configuration, while group leadership accesses a consolidated view — unified patient records, group analytics and centralized governance reporting.",
  },
  {
    q: "What clinical decision support is included in the HIS?",
    a: "Drug interaction checking, allergy cross-referencing, dose validation, duplicate detection, sepsis screening, early warning score automation, preventive care reminders, evidence-based order sets and condition-specific pathways. The CDS library is configurable by your clinical informatics team.",
  },
  {
    q: "How does the system support nursing handover and shift communication?",
    a: "Structured handover tools are built in — allowing nurses to complete a standardized handover record for every patient, flagging active concerns, pending results and anticipated events. Handover completion is tracked and reported as part of the clinical documentation.",
  },
  {
    q: "What training and support are provided after go-live?",
    a: "Every deployment includes a structured pre-go-live training program by role, on-site go-live support, and ongoing support through a dedicated team with SLA-defined response times. Updates, compliance releases and new features are included.",
  },
];
      ...
      <section className="relative z-20 -mt-12 rounded-t-[2.5rem] bg-background px-6 py-24 shadow-[0_-20px_60px_-20px_rgba(0,0,0,0.4)] md:px-12 md:py-32">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <p className="mx-auto mt-8 max-w-3xl text-base leading-relaxed text-muted-foreground md:text-lg">
            ...
            disconnected — different platforms for pharmacy, laboratory, radiology, nursing,
            billing, and management — information is delayed, duplicated, and lost. Secreta HIS is a
            fully integrated, enterprise-grade Hospital Information System that connects every
            department, every workflow, and every data point in your facility into one unified
            clinical and operational platform. Built for the complexity of modern healthcare.
            Designed for the humans who deliver it.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-5 text-base leading-relaxed text-foreground/70 md:text-lg">
              From the moment a patient is registered to the moment their account is settled and
              their record is archived — every department, every discipline and every data point
      ...
      <section className="px-6 py-24 md:px-12">
        <div className="mx-auto max-w-6xl">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-5 text-base leading-relaxed text-foreground/70 md:text-lg">
              Secreta HIS is built on open standards — not a proprietary integration model that
              locks you into a single vendor ecosystem. Every external system that needs to connect,
              can.
            </p>
          </div>
      ...
      >
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <p className="mt-8 text-lg leading-relaxed text-white/80">
            Every patient deserves complete information at the point of care. Every clinician
            deserves a system that supports their work instead of obstructing it. Every leader
            deserves accurate, real-time data.
          </p>
          <p className="mt-6 text-lg leading-relaxed text-white/80">
            A truly integrated Hospital Information System is not a technology investment. It is the
            foundation of every clinical, operational and financial improvement your organization
            will make for the next decade.
          </p>
          ...
          <p className="mt-8 text-sm italic text-white/60">
            Structured implementation support. Data migration included. Pricing tailored to your
