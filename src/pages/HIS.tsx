...
import { useHISContent, splitAccent } from "@/lib/hisContent";

// Icon lookup so builder-editable icon names resolve to lucide components.
...
export default function HIS() {
  ...
  const introTitle = splitAccent(intro.headline, (intro as any).headlineAccent ?? "Modern Healthcare");
  const problemTitle = splitAccent(problem.heading, (problem as any).headingAccent ?? "Dangerous Hospital.");
