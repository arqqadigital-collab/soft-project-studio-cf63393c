...
const ICONS: Record<string, LucideIcon> = {
  ...
  HeartPulse, AlertTriangle, CheckCircle2, ShieldCheck, Network, Workflow,
};
        ...
        <section className="px-6 py-24 md:px-12">
          <div className="mx-auto max-w-6xl text-center">
            ...
            <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
              {c.Integrations.items.map((logo: any) => (
                <img
                  key={logo.name}
                  src={logo.logo}
                  alt={logo.name}
          ...
          <div className="relative mx-auto max-w-4xl text-center">
            ...
            <div className="mt-12 flex flex-col items-center justify-center gap-4 sm:flex-row">
              {c["Final CTA"].primaryLabel && (
                <a
                  href={c["Final CTA"].primaryHref || "#contact"}
              ...
              {c["Final CTA"].secondaryLabel && (
                <a
                  href={c["Final CTA"].secondaryHref || "#contact"}
            ...
            {c["Final CTA"].footnote && (
              <p className="mt-8 text-sm italic text-white/70">{c["Final CTA"].footnote}</p>
            )}
          </div>
        </section>
      )}
