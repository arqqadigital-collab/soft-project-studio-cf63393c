      ...
      <section id="contact" className="relative overflow-hidden px-6 py-24 md:px-12" style={{ backgroundColor: "#091628" }}>
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <div className="mt-12 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <a href={c["Final CTA"].ctaHref} className="inline-flex items-center gap-3 rounded-full px-10 py-5 text-base font-semibold text-white shadow-[var(--shadow-brand)] transition-transform hover:scale-105" style={{ background: "var(--gradient-brand)" }}>
              {c["Final CTA"].ctaLabel} <ArrowRight className="h-5 w-5" />
            </a>
            <a href={c["Final CTA"].ctaHref2} className="inline-flex items-center gap-3 rounded-full border border-white/30 bg-white/5 px-10 py-5 text-base font-semibold text-white backdrop-blur transition-colors hover:bg-white/15">
