...
const features = [
  ...
  { icon: Share2, title: "Riayati Integration — Dubai HIE", body: "Real-time integration with Riayati. Clinical summaries, medications, and care history are shared and retrieved automatically at the point of care with DHA-compliant consent workflows." },
  { icon: Database, title: "Malaffi Integration — Abu Dhabi HIE", body: "Certified Malaffi integration for real-time record sharing. Admissions, discharges, diagnoses, medications, and allergies are submitted automatically with full DOH compliance." },
  { icon: Globe2, title: "Qatar NHIX Integration", body: "Connect to Qatar's National Health Information Exchange for eligibility verification, prior authorization, claims processing, and clinical data sharing with pre-built Qatari payer profiles." },
  { icon: FileBadge, title: "Bahrain NHRA Compliance", body: "Full NHRA alignment with certified claim submission pathways, Bahraini clinical coding standards, licensing and credentialing records, and MOH Bahrain public health integrations." },
  { icon: MapPin, title: "Kuwait & Oman Alignment", body: "Country-specific insurance workflows, clinical coding standards, MOH reporting formats, and regulatory documentation for facilities in Kuwait and Oman — no manual adaptation needed." },
  { icon: ShieldCheck, title: "UAE Federal Data Protection", body: "Full compliance with UAE Federal Decree-Law No. 45 of 2021. Data residency options, consent management, data subject rights, and breach notification workflows built in." },
  { icon: Languages, title: "Arabic & English Bilingual", body: "Every screen, clinical form, patient document, and regulatory report is fully functional in Arabic and English across all GCC country configurations — with no loss of functionality." },
  { icon: Layers, title: "Group-Level Consolidation", body: "Unified management layer consolidating clinical, operational, and financial data across all sites and countries. Local compliance, group-wide visibility — in a single view." },
];
...
const faqs = [
  { q: "Do you support both DHA and DOH compliance in the same system?", a: "Yes. Facilities operating in both Dubai and Abu Dhabi can run both DHA and DOH compliance configurations within a single Secreta deployment. Claims, reports, and integrations are automatically routed through the correct regulatory pathway based on each facility's location and license." },
  { q: "Is your Malaffi integration currently certified?", a: "Yes. Our Malaffi integration holds active DOH certification and covers the full mandatory data sharing transaction set — admissions, discharges, diagnoses, medications, allergies, and clinical summaries. It is tested against each Malaffi platform release before deployment." },
  { q: "How do you handle regulatory changes across six GCC markets?", a: "Secreta employs a dedicated GCC regulatory compliance team that monitors all markets continuously. When changes are confirmed, the relevant modules are updated and deployed before the effective date, with advance communication to clients." },
  { q: "Can a healthcare group see consolidated reporting across all GCC operations?", a: "Yes. The group management layer consolidates clinical, operational, and financial data from all facilities and countries into a unified executive view, while country-specific compliance reports remain available for local regulatory use." },
  { q: "How is patient data handled across borders within a GCC group?", a: "Data handling is configured to comply with each country's data protection law. Cross-border transfers within a group are governed by the most restrictive applicable framework, and data residency options are available for each country." },
  { q: "How long does regional implementation take for a multi-country group?", a: "Single-country implementations typically complete in 4 to 8 weeks. Full GCC regional deployments across four to five countries typically span 4 to 6 months with a dedicated regional project team." },
];
        ...
        <div className="mx-auto max-w-6xl">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-5 text-base leading-relaxed text-foreground/70 md:text-lg">
              A single integrated platform with country-specific configuration depth — pre-built for every major GCC
              regulator, payer, and national health platform.
            </p>
          </div>
      ...
      <section className="bg-background px-6 py-24 md:px-12 md:py-32">
        <div className="mx-auto max-w-6xl">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-5 text-base leading-relaxed text-foreground/70 md:text-lg">
              From mapping to continuous alignment — every country, every regulator, every payer covered end to end.
            </p>
          </div>
      ...
      <section className="relative overflow-hidden px-6 py-24 md:px-12" style={{ backgroundColor: "#091628" }}>
        ...
        <div className="relative mx-auto max-w-6xl">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-sm text-white/65 md:text-base">Across our GCC client network.</p>
          </div>
      ...
      >
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <p className="mt-8 text-lg leading-relaxed text-white/80">
            Give your organization the platform that makes GCC compliance a strength rather than a burden.
          </p>
          ...
          <p className="mt-8 text-sm italic text-white/60">
            GCC-based implementation team. Arabic and English support across all markets. Regulatory updates included.
          </p>
        </div>
      </section>
