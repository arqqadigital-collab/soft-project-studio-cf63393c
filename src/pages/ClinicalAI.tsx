...
const ICONS: Record<string, LucideIcon> = {
  ...
  ShieldCheck, Users, GitBranch, Activity, BadgeCheck, Target,
};
...
<section
      ...
      {/* HOW IT WORKS */}
      {v["How It Works"] && (
        <StyledSection style={content._style?.["How It Works"]}>
<section className="bg-background px-6 py-24 md:px-12 md:py-32">
        <div className="mx-auto max-w-6xl">
          <div className="mx-auto max-w-3xl text-center">
            <span className="text-xs font-semibold uppercase tracking-[0.3em] text-[color:var(--brand-blue)]">
              {c["How It Works"].eyebrow}
            </span>
            <h2 className="mt-4 text-3xl font-bold tracking-tight text-foreground md:text-5xl">
              {c["How It Works"].heading}
            </h2>
            <p className="mt-5 text-base leading-relaxed text-foreground/70 md:text-lg">
              {c["How It Works"].body}
            </p>
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            {c.Integrations.groups.map((group: any) => (
              <div key={group.title} className="rounded-3xl border border-border bg-card p-8 shadow-sm">
